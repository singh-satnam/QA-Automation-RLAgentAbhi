...
pytest_plugins = ('step_defs.common_steps', 'step_defs.admin_account_settings_steps', 'step_defs.admin_create_new_org_steps', 'step_defs.admin_login_steps', 'step_defs.admin_user_catalog_steps', 'step_defs.admin_users_filter_search_steps', 'step_defs.create_delete_key_pair_steps', 'step_defs.logout_via_signout_steps', 'step_defs.pi_add_and_remove_user_from_project_steps', 'step_defs.pi_add_budget_to_project_steps', 'step_defs.pi_add_remove_user_from_project_steps', 'step_defs.pi_admin_user_cannot_be_added_to_project_steps', 'step_defs.pi_login_steps', 'step_defs.pi_my_projects_count_steps', 'step_defs.pi_product_details_for_project_steps', 'step_defs.pi_project_creation_steps', 'step_defs.pi_project_details_active_project_steps', 'step_defs.researcher_login_steps')
