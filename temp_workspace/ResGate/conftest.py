...
pytest_plugins = ('step_defs.common_steps', 'step_defs.admin_login_steps', 'step_defs.logout_via_signout_steps', 'step_defs.pi_add_budget_to_project_steps', 'step_defs.pi_login_steps', 'step_defs.pi_project_creation_steps', 'step_defs.pi_project_details_active_project_steps', 'step_defs.researcher_login_steps')
