...
class CreateProjectPage(BasePage):
    ...
    def select_catalog_type(self, catalog_partial):
        # Catalog checkbox input is CSS-hidden; click the visible label by partial text.
        self.page.locator("label.selection-label").filter(has_text=catalog_partial).first.click()
