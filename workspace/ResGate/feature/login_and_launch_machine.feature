...
Feature: Login and Launch Remote Desktop Machine
  ...
  Scenario: Login navigate to project product and launch remote desktop
    ...
    Then "Demo-RD-3926" is available
    And "Demo-RD-3926" is in green "Active" status
    When the user clicks on "Demo-RD-3926"
    Then the user lands on the product details of "Demo-RD-3926"
