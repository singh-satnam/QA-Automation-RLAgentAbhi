Feature: Login and stop the instance
  ...
  Scenario: Login and stop the Demo-RD-1096 instance
    ...
    Then "Demo-RD-1096" is available
    And the "Demo-RD-1096" is in green "Active" status
    When the user clicks on "Demo-RD-1096"
    Then the user lands on the product details page of "Demo-RD-1096"
